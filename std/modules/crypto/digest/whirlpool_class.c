...
static BuiltinResult _digest_whirlpool_hash(int argc, Obj **argv, UNUSED(Obj *, caller)) {
    CHECK_ARG_COUNT(1)
...
static BuiltinResult _digest_whirlpool_init(int argc, UNUSED(Obj **, argv), Obj *caller) {
    CHECK_ARG_COUNT(0)
